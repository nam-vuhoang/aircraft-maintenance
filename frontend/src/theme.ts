...
const customTheme = extendTheme({
  ...
  colors: {
    ...
    secondary: {
      50: 'hsla(14, 100%, 95%, 1)',
      100: 'hsla(14, 100%, 90%, 1)',
      200: 'hsla(14, 100%, 80%, 1)',
      300: 'hsla(14, 100%, 70%, 1)',
      400: 'hsla(14, 100%, 65%, 1)',
      500: 'hsla(14, 100%, 60%, 1)', // secondary
      600: 'hsla(14, 100%, 55%, 1)',
      700: 'hsla(14, 100%, 50%, 1)',
      800: 'hsla(14, 100%, 45%, 1)',
      900: 'hsla(14, 100%, 40%, 1)',
    },
    secondaryGray: {
