import { startOfHour, startOfDay, startOfWeek, startOfMonth, addHours, addDays, addWeeks, addMonths } from 'date-fns';
...
export const getHumanTimeUnitName = (unit: TimeUnit): string => {
  switch (unit) {
    case 'hour':
      return 'Hour';
    case 'hour-1':
